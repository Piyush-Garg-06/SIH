...
import { LogIn, Smartphone, Shield, Heart, Users, ShieldCheck, Eye, EyeOff } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center space-y-8 p-8">
            <div className="relative w-full max-w-md h-96 rounded-3xl overflow-hidden shadow-2xl">
              ...
              {/* Floating cards */}
              <div className="absolute top-6 left-6 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg animate-fade-in">
              ...
              <div className="absolute top-6 right-6 bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-lg animate-fade-in delay-500">
                <div className="flex items-center space-x-2">
                  <ShieldCheck className="w-5 h-5 text-green-500" />
                  <span className="text-sm font-medium text-gray-800">Secure Access</span>
                </div>
              </div>
            </div>
            ...
            <div className="text-center space-y-4 animate-slide-in">
              <h2 className="text-3xl font-bold text-gray-800">Welcome to Digital Health</h2>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className={`w-full max-w-md space-y-8 bg-white/95 backdrop-blur-sm p-8 rounded-3xl shadow-2xl border border-blue-100 transform transition-all duration-700 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
                  ...
                  <div className="transform transition-all duration-300 hover:scale-105">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleChange}
                        className="appearance-none block w-full px-4 py-3 pr-12 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 sm:text-sm bg-white hover:border-blue-400 transition-all duration-300 hover:shadow-md focus:scale-105"
